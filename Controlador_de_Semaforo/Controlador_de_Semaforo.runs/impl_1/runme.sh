...
HD_PWD='C:/Users/AC Tecnologia/Documents/Trabalho Final PED1/Controlador_de_Semaforo/Controlador_de_Semaforo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controladorSemaforo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controladorSemaforo.tcl -notrace
