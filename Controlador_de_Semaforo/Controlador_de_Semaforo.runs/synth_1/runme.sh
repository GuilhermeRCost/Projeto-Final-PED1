...
HD_PWD='C:/Users/AC Tecnologia/Documents/Trabalho Final PED1/Controlador_de_Semaforo/Controlador_de_Semaforo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controladorSemaforo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controladorSemaforo.tcl
